      ...
      >
        ...
        >
          ...
          <button
            ...
            className="w-12 h-12 flex items-center justify-center rounded-full bg-gray-700 hover:bg-gray-800 text-white shadow-lg"
          >
          ...
          {/* 확장 메뉴 */}
          {open && (
            <div className="absolute left-0 mt-2 bg-white text-gray-900 border border-gray-200 rounded-md shadow-lg w-48 py-2 z-50 space-y-1">
              <button
                onClick={() => {
                  onAddTable?.();
                  setOpen(false);
              ...
              >
                <button className="flex items-center gap-2 w-full text-left px-4 py-2 hover:bg-gray-200 text-sm">
                  <GitCompareArrows size={16} className="text-pink-400" />
                  관계 추가 ▸
                </button>

                {relationMenuOpen && (
                  <div className="absolute left-full top-0 bg-white border border-gray-200 rounded-md shadow-lg w-64 z-50">
